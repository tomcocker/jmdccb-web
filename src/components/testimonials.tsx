            ...
            <div className='container mx-auto'>
                ...
                <Carousel className='mx-auto w-full md:max-w-5xl lg:mt-30'>
                    ...
                    <div className='mt-6 flex items-center justify-center gap-3 lg:mt-24'>
                        ...
                        <CarouselNext variant='default' className='relative top-0 left-0 translate-y-0 lg:p-6' />
                    </div>
                </Carousel>
            </div>
        </section>
...
const LineHorizontal = ({ className = '' }) => (
    <svg height='1' className={cn('absolute h-1 w-full', className)} xmlns='http://www.w3.org/2000/svg'>
        <path
...
const LineVertical = ({ className = '' }) => (
    <svg className={cn('absolute h-full w-1', className)} xmlns='http://www.w3.org/2000/svg'>
        <path
...
const IconSvgs = {
    SvgBorder1: (props: React.SVGProps<SVGSVGElement>) => (
        <svg {...props} width='78' height='73' viewBox='0 0 68 67' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path
    ...
    SvgBorder2: (props: React.SVGProps<SVGSVGElement>) => (
        <svg {...props} width='78' height='73' viewBox='0 0 78 73' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path
